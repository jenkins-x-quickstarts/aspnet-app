...
* [mcr.microsoft.com/dotnet/sdk:7.0-alpine](https://hub.docker.com/_/microsoft-dotnet-sdk/)
* [mcr.microsoft.com/dotnet/aspnet:7.0-alpine](https://hub.docker.com/_/microsoft-dotnet-aspnet/)
